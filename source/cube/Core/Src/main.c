...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : CAMERA_POWER_DOWN_Pin */
  ...
  /*Configure GPIO pins : STOP_B_Pin BASE_SENSE_Pin STOP_A_Pin */
  GPIO_InitStruct.Pin = STOP_B_Pin|BASE_SENSE_Pin|STOP_A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : BLADE_MOTOR_Pin */
  ...
  /*Configure GPIO pin : BLADE_BRAKE_Pin */
  ...
  /*Configure GPIO pin : CAMERA_LIGHT_Pin */
  ...
  /*Configure GPIO pins : LEFT_BACKWARD_Pin LEFT_FORWARD_Pin */
  ...
  /*Configure GPIO pins : TEST_TX_Pin TEST_RX_Pin */
  ...
  /*Configure GPIO pins : CAMERA_RESET_Pin INERTIA_CHIP_SELECT_Pin STATUS_LIGHT_Pin */
  ...
  /*Configure GPIO pins : POWER_ENABLE_Pin MOTOR_ENABLE_Pin WIFI_ENABLE_Pin WIFI_BOOT_MODE_Pin
                           WIFI_RESET_Pin */
  ...
  /*Configure GPIO pin : CAMERA_CLOCK_Pin */
  ...
  /*Configure GPIO pins : RIGHT_FORWARD_Pin RIGHT_BACKWARD_Pin */
